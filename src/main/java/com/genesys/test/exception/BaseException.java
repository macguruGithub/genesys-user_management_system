...
public class BaseException extends RuntimeException {
	...
	private String errorModule = "General Module";
	private String errorMessage;
	private String exceptionMessage;
	private String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss")
			.format(new Timestamp(System.currentTimeMillis()));

	public BaseException(String errorCode, String errorModule, String exceptionMessage, String errorMessage) {
		super();
	...
	public BaseException(String errorCode, String errorModule, String errorMessage) {
		super();
		this.errorCode = errorCode;
		this.errorModule = errorModule;
		this.errorMessage = errorMessage;
